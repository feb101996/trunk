...
describe('<CodeBlock> component', () => {
  it('renders the Code Block component', async () => {
    let component = h(CodeBlock, {
      code: `import { codeToThemedTokens } from 'shiki'

      let tokens = await codeToThemedTokens('<div class="foo">bar</div>', {
        lang: 'html',
        theme: 'min-dark'
      })`,
      lang: 'typescript',
...
<span class="line" style="display: table-row; line-height: 1.5; height: 1.5em;"><span style="color:#FF79C6">      let</span><span style="color:#F8F8F2"> tokens </span><span style="color:#FF79C6">=</span><span style="color:#FF79C6"> await</span><span style="color:#50FA7B"> codeToThemedTokens</span><span style="color:#F8F8F2">(</span><span style="color:#E9F284">'</span><span style="color:#F1FA8C">&#x3C;div class="foo">bar&#x3C;/div></span><span style="color:#E9F284">'</span><span style="color:#F8F8F2">, {</span></span>
...
<span class="line" style="display: table-row; line-height: 1.5; height: 1.5em;"><span class="line-number" style="padding-left: 5px; padding-right: 15px; color: #636E7B; user-select: none;">3</span><span style="color:#FF79C6">      let</span><span style="color:#F8F8F2"> tokens </span><span style="color:#FF79C6">=</span><span style="color:#FF79C6"> await</span><span style="color:#50FA7B"> codeToThemedTokens</span><span style="color:#F8F8F2">(</span><span style="color:#E9F284">'</span><span style="color:#F1FA8C">&#x3C;div class="foo">bar&#x3C;/div></span><span style="color:#E9F284">'</span><span style="color:#F8F8F2">, {</span></span>
